...
//need to have points entered add to exactly 100

//should be a submit button. Submit button causes the emit to cause the parent component
//to transition to the next page. first checks to make sure all inputs are integers that are greater than 0
//and add up to 100
...
export default {
    ...
    methods:{
        ...
        nextPage(){ //what does overall survey page need to have?
