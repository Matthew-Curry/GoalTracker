    ...
    <div v-for="(value, index) in prio_" :key="value">
      ...
      <div v-show="booleanList[index]">
        ...
        <input
          type="number"
          id="2"
          v-on:input="measure = $event.target.value"
        ...
        <!--Different Days -->
        <br />
        <input type="checkbox" id="4" v-on:input="mon = $event.target.value" />Monday
        <br />
        <input type="checkbox" id="5" v-on:input="tues = $event.target.value" />Tuesday
        <br />
        <input type="checkbox" id="6" v-on:input="wen = $event.target.value" />Wednesday
        <br />
        <input type="checkbox" id="7" v-on:input="thurs = $event.target.value" />Thursday
        <br />
        <input type="checkbox" id="8" v-on:input="fri = $event.target.value" />Friday
        <br />
        <input type="checkbox" id="9" v-on:input="sat = $event.target.value" />Saturday
        <br />
        <input type="checkbox" id="10" v-on:input="sun = $event.target.value" />Sunday
        <br />
  ...
  methods: {
    ...
    checkSubmit() {
      ...
      for (var i = 0; i < this.prio_.length; i++) {
        ...
        goal_iter: for (var j = 0; j < this.goal_list.length; j++) {
